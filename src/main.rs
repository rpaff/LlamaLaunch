...
impl LlamaServerManagerApp {
    ...
    fn draw_home(&mut self, ctx: &egui::Context) {
                        ...
                        frame.show(ui, |ui| {
                            ...
                            ui.label(
                                egui::RichText::new(name)
                                    .size(16.0)
                                    .strong()
                                    .color(Self::card_title_color(theme, *is_active)),
                            );
                            if !desc.is_empty() {
                                ui.label(
                                    egui::RichText::new(desc)
                                        .size(12.0)
                                        .color(Self::card_desc_color(theme, *is_active)),
                                );
                            }
                            ui.separator();
                            if *is_active {
        ...
        if self.running_model.is_some() {
            egui::TopBottomPanel::bottom("logs_panel")
                ...
                .show(ctx, |ui| {
                    ui.scope(|ui| {
                        Self::style_logs_panel(ui, theme);
                        ui.horizontal(|ui| {
                            if self.running_model.is_some() {
                                ui.label(
                                    egui::RichText::new("Logs — loading...")
                                        .strong()
                                        .color(Self::logs_accent_color(theme)),
                                );
                            } else {
                                ui.label(egui::RichText::new("Logs").strong().color(Self::text_color(theme)));
                            }
                            ui.separator();
    ...
    fn style_panel(ui: &mut egui::Ui, theme: config::Theme) {
        match theme {
            ...
            config::Theme::Dark => {
                ui.visuals_mut().override_text_color = Some(egui::Color32::from_white_alpha(255));
    ...
    fn style_logs_panel(ui: &mut egui::Ui, theme: config::Theme) {
        match theme {
            config::Theme::Light => {
                ui.visuals_mut().override_text_color = Some(egui::Color32::from_black_alpha(255));
                ui.visuals_mut().panel_fill = egui::Color32::from_rgb(30, 30, 30);
    ...
    fn card_bg_color(theme: config::Theme) -> egui::Color32 {
        match theme {
            config::Theme::Light => egui::Color32::from_rgb(50, 50, 50),
            config::Theme::Dark => egui::Color32::from_rgb(60, 60, 60),
        }
    }

    fn card_border_color(theme: config::Theme) -> egui::Color32 {
        match theme {
            config::Theme::Light => egui::Color32::from_rgb(204, 204, 204),
            config::Theme::Dark => egui::Color32::from_rgb(80, 80, 80),
        }
    }

    fn card_title_color(theme: config::Theme, is_active: bool) -> egui::Color32 {
        match theme {
            config::Theme::Light => {
                if is_active {
                    egui::Color32::WHITE
    ...
    fn card_desc_color(theme: config::Theme, is_active: bool) -> egui::Color32 {
        match theme {
            config::Theme::Light => {
                if is_active {
    ...
    fn text_color(theme: config::Theme) -> egui::Color32 {
        match theme {
            config::Theme::Light => egui::Color32::from_black_alpha(255),
            config::Theme::Dark => egui::Color32::from_white_alpha(255),
        }
    }

    fn logs_accent_color(theme: config::Theme) -> egui::Color32 {
        match theme {
            config::Theme::Light => egui::Color32::YELLOW,
            config::Theme::Dark => egui::Color32::from_rgb(255, 220, 0),
        }
    }
